  ...
  render() {
    ...
    return (
      <li className="list-item">
        <a href={`${BASE_PAGE_DIR}/underwear/${this.props.id}`} className="img-wrap" style={{backgroundImage: img, height: height}}></a>
        <a href={`${BASE_PAGE_DIR}/underwear/${this.props.id}`} className="pro-name">
          <p>{this.props.name}</p>
