        ...
        lastColumn = (
          <div className="column">
            <div className="row-wrap">
              ...
              { this.props.itemType == '0'? '' : (<div className="extra-col"><div className="prepay">押</div></div>)}

            </div>
            <div className="row-wrap">
              <div className="info-col"><i>尺码:</i><span className="arial pl5">75C</span></div>
            </div>
            <div className="row-wrap">
      ...
      case ROUTER_SHOPPING_CART_EDIT:
        ...
        if (this.props.itemType == '1') {
          boxes = this.props.boxes.map((item, index, boxes) => {
            return (<div className={this.isSameWithBox(item)? "box-service-item on" : "box-service-item"} key={index}>{item.baseSize}{item.braSize}</div>)
          })
        }
        if (this.props.itemType == '0') {
          numOperate = (
            <div className="num-wrap info-col">
              <div className="iconfont btn-minus" data-group-id={this.props.groupId} data-item-id={this.props.itemId}>&#xe601;</div>
              <div className="num">{this.props.source.count}</div>
              <div className="iconfont btn-add" data-group-id={this.props.groupId} data-item-id={this.props.itemId}>&#xe601;</div>
            </div>)
        }
        ...
        lastColumn = (
          <div className="column">
            ...
            <div className="row-wrap">
              { this.props.itemType == '0'? (<div className="btn-box info-col">添加盒子服务</div>) : null}
